...
class EmailService {
              ...
              <tr>
                  <td align="center" style="padding: 40px 20px;">
                      ...
                      <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                          <!-- Header -->
                          <tr>
                              <td style="padding: 40px 40px 30px; text-align: center; background: linear-gradient(135deg, #ff4e50 0%, #f9d423 100%); border-radius: 12px 12px 0 0;">
                          ...
                          <tr>
                              <td style="padding: 30px 40px; text-align: center; background-color: #f8f9fa; border-radius: 0 0 12px 12px; border-top: 1px solid #e9ecef;">
                                  <p style="margin: 0; color: #6c757d; font-size: 13px; line-height: 1.5;">
                                      ...
                                      <span style="color: #adb5bd;">Campaign Manager © 2025</span>
                                  </p>
                              </td>
                          </tr>
                      </table>
  ...
  async sendEmail(recipientEmail, name, message) {
    if (!this.isEmailValid(recipientEmail)) {
